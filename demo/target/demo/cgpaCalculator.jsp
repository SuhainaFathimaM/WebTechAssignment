...
<body>
    <div class="container">
        ...
        <%
            // Step 1: get number of subjects from form input
            ...
            // Step 2: if subjects is set and marks are submitted, calculate CGPA
            if (request.getParameter("calculate") != null && subjects > 0) {
                ...
                // Create and set JavaBean properties
        ...
        <%
            // If number of subjects is set, show input fields for marks and credits
            if (subjects > 0) {
        %>
        <form method="post">
